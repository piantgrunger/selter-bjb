...
$yearsnow		      = date("Y");
              	 	...
              	 	$sql_periode 	= "SELECT * FROM periode where status='Aktif' ";
					$mysql_periode	= mysqli_query($conn, $sql_periode);
					$data 			= mysqli_fetch_array($mysql_periode);
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="material-pro/src/assets/images/favicon.png">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Jabatan Yang Akan Diisi</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Selter</a></li>
                        <li class="breadcrumb-item active">Jabatan Yang Akan di isi</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
               <?php include "jabatan-selter-isi.php"; ?>
