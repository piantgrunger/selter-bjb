        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Upload File Pengumuman</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Upload File</a></li>
                        <li class="breadcrumb-item active">Pastikan semua file tidak lebih dari 1 Mb</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
               <?php include "file-pengumuman-isi.php"; ?>
