                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" action='assets/input-file-upload-10.php' method='post' enctype='multipart/form-data'>
                                    <div class="form-group mt-4 row">
                                        ...
                                        <div class="col-md-10">
										   ...
										   <span class="help-block"><small>Pas photo terbaru latar merah </small></span>
