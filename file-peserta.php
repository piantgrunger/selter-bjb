...
$yearsnow		      = date("Y");
	...
	$sql_peserta2	= "select * from pilih_jabatan where id_periode='$id_periode' and id_peserta='$id_peserta'";
	$mysql_peserta2	= mysqli_query ($conn, $sql_peserta2);
	$data_peserta2	= mysqli_fetch_array($mysql_peserta2);
	$id_pilih	 	= $data_peserta2['id_pilih'];
?>
<!DOCTYPE html>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Data File Yang Pian Upload</h3>
            ...
            <div class="container-fluid">
               <?php include "file-peserta-isi.php"; ?>
