        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
               ...
               <?php include "pages/user-profile.php"; ?>
                ...
                <!-- Sidebar navigation-->
                <?php include "pages/sidebar-biasa.php"?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Pendaftaran Peserta Seleksi Terbuka</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Peserta</a></li>
                        <li class="breadcrumb-item active">Pendaftaran Peserta Selter</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
               <?php include "pendaftaran-peserta-isi.php"; ?>
