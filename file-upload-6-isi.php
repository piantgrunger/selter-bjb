                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" action='assets/input-file-upload-6.php' method='post' enctype='multipart/form-data'>
                                    <div class="form-group mt-4 row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">SK Kenaikan Pangkat terakhir</label>
                                        <div class="col-md-10">
                                           <input type="file" name="file" class="form-control" id="exampleInputFile" aria-describedby="fileHelp" required>
										   <span class="help-block"><small>Scan Fotocopy Surat Keputusan Kenaikan Pangkat terakhir yang telah dilegalisir oleh pejabat yang berwenang</small></span>
