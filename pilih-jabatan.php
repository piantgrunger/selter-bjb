        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Jabatan Yang Akan Dilamar</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Selter</a></li>
                        <li class="breadcrumb-item active">Pilih Jabatan Yang Akan diLamar</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
               <?php include "pilih-jabatan-isi.php"; ?>
