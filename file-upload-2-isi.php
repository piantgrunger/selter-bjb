                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" action='assets/input-file-upload-2.php' method='post' enctype='multipart/form-data'>
                                    <div class="form-group mt-4 row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Daftar Riwayat Hidup </label>
                                        <div class="col-md-10">
                                           <input type="file" name="file" class="form-control" id="exampleInputFile" aria-describedby="fileHelp" required>
										   <span class="help-block"><small>Scan Daftar riwayat hidup yang ditandatangani</small></span>
