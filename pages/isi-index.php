                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home"
                                        role="tab"><span class="d-none d-md-block">Activity</span><span class="d-block d-md-none"><i class="mdi mdi-bulletin-board"></i></span></a>                                </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile"
                                        role="tab"><span class="d-none d-md-block">Profile</span><span class="d-block d-md-none"><i class="mdi mdi-face-profile"></i></a>                                </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings"
                                        role="tab"><span class="d-none d-md-block">Settings</span><span class="d-block d-md-none"><i class="mdi mdi-settings"></i></a>                                </li>
                            </ul>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline position-relative">
                                                    ...
                                                    <div>
                                                        <div class="d-md-flex">
                                                            <h5 class="mb-0 font-weight-light">
                                                                <a href="#" class="link">John Doe</a>                                                            </h5>
                                                            <span class="sl-date text-muted ml-1">5 minutes ago</span>                                                        </div>

                                                        <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="material-pro/src/assets/images/big/img1.jpg" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="material-pro/src/assets/images/big/img2.jpg" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="material-pro/src/assets/images/big/img3.jpg" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="material-pro/src/assets/images/big/img4.jpg" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                        </div>
                                                        <div class="text-nowrap"> 
                                                            <a href="javascript:void(0)" class="link mr-2">2 comment</a> 
                                                            <a href="javascript:void(0)" class="link mr-2"><i class="fa fa-heart text-danger"></i> 5 Love</a>                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="sl-item mt-2 mb-3">
                                                <div class="sl-left float-left mr-3"> <img
                                                        src="material-pro/src/assets/images/users/2.jpg" alt="user"
                                                        class="rounded-circle"> </div>
                                                <div class="sl-right">
                                                    <div>
                                                        <div class="d-md-flex">
                                            ...
                                            <div class="sl-item mt-2 mb-3">
                                                <div class="sl-left float-left mr-3"> <img
                                                        src="material-pro/src/assets/images/users/3.jpg" alt="user"
                                                        class="rounded-circle"> </div>
                                                <div class="sl-right">
                                                    <div>
                                                        <div class="d-md-flex">
                                            ...
                                            <div class="sl-item mt-2 mb-3">
                                                <div class="sl-left float-left mr-3"> <img
                                                        src="material-pro/src/assets/images/users/4.jpg" alt="user"
                                                        class="rounded-circle"> </div>
                                                <div class="sl-right">
                                                    <div>
                                                        <div class="d-md-flex">
                                                        ...
                                                        <blockquote class="mt-2">
                                                            ...
                                                            sed do eiusmod tempor incididunt                                                        </blockquote>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
